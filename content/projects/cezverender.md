...
description: A real-time 3D renderer written from scratch in Java, on OpenGL 3.3
  and LWJGL, and my first large project.
tags:
  - java
  - opengl
  - lwjgl
...
cubemap face has to do with a point light, rather than from fighting a language I was
...
handling, covering position, rotation and scale.
...
Java 17 or newer is the only prerequisite, since the repo ships the Maven Wrapper, so
...
Issues and pull requests are welcome, and the repo is meant to be picked apart.